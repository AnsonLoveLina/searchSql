...
public class SqlUtil {
    ...
    private static int MAX_TIMEOUT = 70000;
     ...
     * @return
     */
    private static CloseableHttpClient getClient(String url, String username, String password) {
     ...
     * @return
     */
    public static String post(String url, Map<String, String> headers, String body, String charset, String username, String password) {
        ...
        //创建HttpClient对象
        CloseableHttpClient httpClient = getClient(url, username, password);
        //创建请求方法的实例，并填充url
