...
public class ESDatabaseMetaData implements DatabaseMetaData{
	...
	public String getDatabaseProductName() throws SQLException {
		return Util.ELASTICSEARCH_NAME;
	}

	@Override
	public String getDatabaseProductVersion() throws SQLException {
		return Util.ELASTICSEARCH_VERSION;
	}

	@Override
	public String getDriverName() throws SQLException {
		return ElasticSearchDriver.class.getName();
	}
	...
	public int getDriverMajorVersion() {
		return Util.DRIVER_MAJOR_VERSION;
	}

	@Override
	public int getDriverMinorVersion() {
		return Util.DRIVER_MINOR_VERSION;
	}
	...
	public int getMaxRowSize() throws SQLException {
		Object o = clientInfo.get(Util.PROP_DEFAULT_ROW_LENGTH);
...
//		result.setTotal(result.getNrRows());
	...
	private int addColumnInfo(Map<String, Object> info, String parent, int nextIndex, String esIndex, String esType, ElasticSearchResultSet result,
			...
			//}else
				...
				switch (type){
					...
					case "text" :
						...
						break;
					case "long" :
						row.set(4, ESJDBCUtil.getTypeIdForObject(Long.valueOf(1)));
						break;
					case "integer" :
						row.set(4, ESJDBCUtil.getTypeIdForObject(Integer.valueOf(1)));
						break;
					case "double" :
						row.set(4, ESJDBCUtil.getTypeIdForObject(Double.valueOf(1)));
						break;
					case "float" :
						row.set(4, ESJDBCUtil.getTypeIdForObject(Float.valueOf(1)));
						break;
					case "date" :
						row.set(4, ESJDBCUtil.getTypeIdForObject(new Timestamp(1L)));
						// ToDO: check Timestamp
						break;
					case "short" :
						row.set(4, ESJDBCUtil.getTypeIdForObject(Short.valueOf((short)1)));
						break;
					case "byte" :
						row.set(4, ESJDBCUtil.getTypeIdForObject(Byte.valueOf((byte)1)));
						break;
					case "boolean" :
